...
sourceNote: Το Πουλί με τα Δύο Κεφάλια προέρχεται από την Παντσατάντρα, τη
  ...
  «Καλίλα και Ντίμνα» — το ίδιο βιβλίο από το οποίο έρχεται και το <a
  href="/stories/galazio-tsakali/">Γαλάζιο Τσακάλι</a> της συλλογής μας. Η
  διασκευή της Παραμυθούπολης απευθύνεται σε παιδιά.
